      ...
      J_MULT_LOOP: DO JJ=MR%J_LOWER,MR%J_UPPER
         I_MULT_LOOP: DO II=MR%I_LOWER,MR%I_UPPER
            ...
            ELSE
               ...
               !CURRENT_MPI_PROCESS = MODULO(NM-1, N_MPI_PROCESSES)
...
CHARACTER(LABEL_LENGTH) :: TEXTURE_MAP,HEAT_TRANSFER_MODEL
CHARACTER(25) :: COLOR
...
NAMELIST /INIT/ CELL_CENTERED,CTRL_ID,DB,DENSITY,DEVC_ID,DIAMETER,DT_INSERT,DX,DY,DZ,&
                ...
                RADIUS,RAMP_Q,RTE_CORRECTION,SHAPE,SPEC_ID,TEMPERATURE,T_INSERT,UNIFORM,UVW,VOLUME_FRACTION,XB,XYZ,&
...
PROC_DEVC_LOOP: DO N=1,N_DEVC
   ...
   IF (DV%SPATIAL_STATISTIC/='null' .OR. DV%TEMPORAL_STATISTIC/='null') THEN
      CALL CHANGE_UNITS(DV%QUANTITY,DV%UNITS,DV%SPATIAL_STATISTIC,DV%TEMPORAL_STATISTIC,LU_ERR)
   ENDIF
